...
const GarageDetails = () => {
  ...
  // In the component, update image rendering:
  const mainImage = garage.images?.[selectedImage]
    ? getImageUrl(garage.images[selectedImage])
      ...
      <div className="details-container">
        ...
        <div className="gallery-section">
          <div className="main-image">
            <img
              src={
                garage.images?.[selectedImage] ||
                "https://via.placeholder.com/800x400?text=Garage"
              }
              alt={garage.title}
            />
          </div>
            ...
            {garage.images?.map((image, index) => (
              ...
              >
                <img
                  ...
                  alt={`${garage.title} - ${index + 1}`}
                  onError={(e) => {
                    e.target.src = DEFAULT_GARAGE_IMAGE;
                  }}
                />
              </div>
            ))}
          ...
          <div className="booking-card">
            ...
            <div className="host-info">
              ...
              <div className="host-rating">
                ...
                <span>
                  {garage.host?.rating} · {garage.host?.reviews || 0} reviews
                </span>
              </div>
            </div>
